# %% [markdown]
# # فولاد — the FULLY VOCALIZED lyric, five takes
#
...
# EVERY VOWEL WRITTEN, QURAN-STYLE (operator, 2026-09-10): "the lyric must have all the vowels
# like in quran to minimize any chance of mishaps". 435 marks over 30 lines — every consonant
# governed by a fathe, kasre, zamme or sukūn, long vowels as mark plus letter — so the model has
# nothing left to guess. Five seeds of that one form; the Latin comparison renders in parallel on
# ashranet/foolad-audition. Caption only; nothing discarded; the register read is disclosure.
ARMS = [("quran", LYRICS_VOC, (6006, 6005, 6002, 6003, 6004))]
report = []
