# UNBROKEN — steps A/B: 40 vs 60 vs 80 at a fixed seed, so the step count is a
# measured trade instead of an asserted one. ~15 GPU-minutes of question.
#
...
TAKES = [
    # One variable: steps. t3's exact seed/caption/cfg — the same-seed convergence test that
    # turns "is 60 steps enough on a 4.6B model" from an assertion into a diff.
    ("steps40", "cinematic, orchestral, baritone", 40, 7.5, 7322),
    ("steps60", "cinematic, orchestral, baritone", 60, 7.5, 7322),
    ("steps80", "cinematic, orchestral, baritone", 80, 7.5, 7322),
]
DURATION = 180.0
